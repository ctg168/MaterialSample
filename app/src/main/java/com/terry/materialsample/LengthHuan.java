...
public class LengthHuan extends Huan {
    ...
    public LengthHuan() {
        ...
        HuanItem huanItem_chi = new HuanItem(6, "尺", "chi", EqualTypeEnum.Equal, huanItem_m.formula.divide(new BigDecimal("3.0"), 100, BigDecimal.ROUND_HALF_EVEN), "", true, false, "1米/3");
        ...
        HuanItem huanItem_cun = new HuanItem(7, "寸", "cun", EqualTypeEnum.Equal, huanItem_chi.formula.divide(new BigDecimal("10.0"), 100, BigDecimal.ROUND_HALF_EVEN), "", true, false, "1米/30(3.33厘米)");

//        HuanItem huanItem_chi = new HuanItem(6, "尺", "chi", EqualTypeEnum.Equal, new BigDecimal(huanItem_m.formula.doubleValue() / 3.0), "", true, false, "1米/3");
//        HuanItem huanItem_zhang = new HuanItem(5, "丈", "zhang", EqualTypeEnum.Equal, new BigDecimal(huanItem_chi.formula.doubleValue() * 10), "", true, false, "10米/3");
//        HuanItem huanItem_cun = new HuanItem(7, "寸", "cun", EqualTypeEnum.Equal, new BigDecimal(huanItem_chi.formula.doubleValue() / 10), "", true, false, "1米/30(3.33厘米)");
